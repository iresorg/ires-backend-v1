...
import { EnvVariables, validateEnv } from '@/utils/env.validate';
import "dotenv/config";

export function createDataSourceOptions(env?: Partial<EnvVariables>): DataSourceOptions {
...
export function createDataSourceFactory(configService: ConfigService<EnvVariables>): DataSourceOptions {
